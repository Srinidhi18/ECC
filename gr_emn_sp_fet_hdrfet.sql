...
****************************************************************************************    
 ...
 /*Balasubramaniyam P 09/08/2019  EBS-3225  */    
  ...
  /* Sathishkumar S            27/03/2023           EBS-5977                         */
***************************************************************************************/    
...
BEGIN    
 ...
 /* Code commented and added for EBS-5977 begins */
 --DECLARE @status_tmp   udd_status    
 DECLARE @status_tmp   udd_desc255 
 /* Code commented and added for EBS-5977 ends */   
...
/*Code Added for EBS-2378 end */    
 ...
 /*Code added for 11H103_GR_00008 begins here*/    
  ...
  IF @ipsStatus='Y'    
   ...
   /*Code comment for 11H103_GR_00008 ends here*/    
      ...
      @createdou = dbo.getouname(grl.gr_lin_projectou)    
 ...
 SELECT @amend_no_tmp         'AMEND_NO',    
    ...
    RTRIM(@bscotype_tmp)       'BSCOTYPE',    
     ...
     ELSE CONVERT(nCHAR(10), ISNULL(@frdate_tmp, dbo.RES_Getdate(@ctxt_ouinstance)), 120)  END 'FRDATE',--code added  for ES_ABB_00858    
